...
{{ include "weatherapp.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "weatherapp.selectorLabels" -}}
...
*/}}
{{- define "weatherapp.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "weatherapp.fullname" .) .Values.serviceAccount.name }}
{{- else }}
